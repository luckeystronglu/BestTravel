...
public class LookPicsActivity extends BaseActivity{
    ...
    protected void init() {
        ...
        TravelNoteEntity travelentity = (TravelNoteEntity) intent.getSerializableExtra("entity");
        List<TravelNoteEntity.ActivityBean.ContentsBean> contents = travelentity.getActivity().getContents();
        int po = intent.getIntExtra("picnum",-1);
    ...
    public static class PicsVpAdapter extends PagerAdapter{
        ...
        private List<TravelNoteEntity.ActivityBean.ContentsBean> piclist;

        public PicsVpAdapter(Context context,List<TravelNoteEntity.ActivityBean.ContentsBean> piclist) {
